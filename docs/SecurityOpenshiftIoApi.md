# OpenShiftApiWithKubernetes.SecurityOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.SecurityOpenshiftIoApi();

apiInstance.getSecurityOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
