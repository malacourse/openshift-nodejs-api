# OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgSdnApisNetworkV1NetNamespace
...
**netid** | **Number** | NetID is the network identifier of the network namespace assigned to each overlay network packet. This can be manipulated with the \&quot;oadm pod-network\&quot; commands. | 
