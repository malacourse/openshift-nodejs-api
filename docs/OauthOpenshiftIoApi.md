# OpenShiftApiWithKubernetes.OauthOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.OauthOpenshiftIoApi();

apiInstance.getOauthOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
