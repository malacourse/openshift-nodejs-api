# OpenShiftApiWithKubernetes.UserOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.UserOpenshiftIoApi();

apiInstance.getUserOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
