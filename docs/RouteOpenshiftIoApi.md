# OpenShiftApiWithKubernetes.RouteOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.RouteOpenshiftIoApi();

apiInstance.getRouteOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
