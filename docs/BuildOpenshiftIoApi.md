# OpenShiftApiWithKubernetes.BuildOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.BuildOpenshiftIoApi();

apiInstance.getBuildOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
