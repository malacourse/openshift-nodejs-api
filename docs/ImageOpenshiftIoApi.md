# OpenShiftApiWithKubernetes.ImageOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.ImageOpenshiftIoApi();

apiInstance.getImageOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
