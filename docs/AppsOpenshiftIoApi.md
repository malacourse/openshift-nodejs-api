# OpenShiftApiWithKubernetes.AppsOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.AppsOpenshiftIoApi();

apiInstance.getAppsOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
