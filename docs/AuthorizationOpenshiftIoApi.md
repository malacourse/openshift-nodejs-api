# OpenShiftApiWithKubernetes.AuthorizationOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.AuthorizationOpenshiftIoApi();

apiInstance.getAuthorizationOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
