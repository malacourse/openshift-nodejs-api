# OpenShiftApiWithKubernetes.NetworkOpenshiftIoApi
...
<a name="getNetworkOpenshiftIoAPIGroup"></a>
# **getNetworkOpenshiftIoAPIGroup**
> IoK8sApimachineryPkgApisMetaV1APIGroup getNetworkOpenshiftIoAPIGroup()
...
let apiInstance = new OpenShiftApiWithKubernetes.NetworkOpenshiftIoApi();

apiInstance.getNetworkOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
