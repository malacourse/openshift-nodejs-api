# OpenShiftApiWithKubernetes.ProjectOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.ProjectOpenshiftIoApi();

apiInstance.getProjectOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
