# OpenShiftApiWithKubernetes.TemplateOpenshiftIoApi
...
let apiInstance = new OpenShiftApiWithKubernetes.TemplateOpenshiftIoApi();

apiInstance.getTemplateOpenshiftIoAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
