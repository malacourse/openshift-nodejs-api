# OpenShiftApiWithKubernetes.AutoscalingApi
...
let apiInstance = new OpenShiftApiWithKubernetes.AutoscalingApi();

apiInstance.getAutoscalingAPIGroup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
