...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook);
    });
