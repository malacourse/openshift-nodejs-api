...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ScaleIOVolumeSource();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1ScaleIOVolumeSource', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1ScaleIOVolumeSource', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1ScaleIOVolumeSource
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ScaleIOVolumeSource();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ScaleIOVolumeSource);
    });
