...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgImageApisImageV1ImageStreamTag);
    });
