...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec();
  });
  ...
  describe('IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentSpec);
    });
