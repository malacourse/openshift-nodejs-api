...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus();
  });
  ...
  describe('IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus', function() {
    it('should create an instance of IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetStatus);
    });
