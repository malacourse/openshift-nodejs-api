...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec();
  });
  ...
  describe('IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec);
    });
