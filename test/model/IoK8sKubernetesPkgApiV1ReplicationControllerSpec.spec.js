...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerSpec();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1ReplicationControllerSpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1ReplicationControllerSpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1ReplicationControllerSpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerSpec);
    });
