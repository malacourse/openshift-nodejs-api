...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken);
    });
    ...
    it('should have the property authorizeToken (base name: "authorizeToken")', function() {
      // uncomment below and update the code to test the property authorizeToken
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgOauthApisOauthV1OAuthAccessToken();
      //expect(instance).to.be();
    });
