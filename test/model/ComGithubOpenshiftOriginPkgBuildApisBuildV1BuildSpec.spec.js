...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSpec);
    });
