...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec();
  });
  ...
  describe('IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec);
    });
