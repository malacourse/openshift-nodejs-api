...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerStatus();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1ReplicationControllerStatus', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1ReplicationControllerStatus', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1ReplicationControllerStatus
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerStatus();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ReplicationControllerStatus);
    });
