...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus();
  });
  ...
  describe('IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus', function() {
    it('should create an instance of IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAppsV1beta1DeploymentStatus);
    });
