...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec();
  });
  ...
  describe('IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec);
    });
