...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest);
    });
    ...
    it('should have the property dockerStrategyOptions (base name: "dockerStrategyOptions")', function() {
      // uncomment below and update the code to test the property dockerStrategyOptions
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property triggeredByImage (base name: "triggeredByImage")', function() {
      // uncomment below and update the code to test the property triggeredByImage
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildRequest();
      //expect(instance).to.be();
    });
