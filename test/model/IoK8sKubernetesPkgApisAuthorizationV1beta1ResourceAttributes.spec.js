...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes();
  });
  ...
  describe('IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes', function() {
    it('should create an instance of IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes);
    });
