...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ContainerStateTerminated();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1ContainerStateTerminated', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1ContainerStateTerminated', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1ContainerStateTerminated
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ContainerStateTerminated();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1ContainerStateTerminated);
    });
