...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1Handler();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1Handler', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1Handler', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1Handler
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1Handler();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1Handler);
    });
