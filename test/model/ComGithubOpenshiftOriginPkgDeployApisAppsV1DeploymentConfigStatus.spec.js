...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigStatus);
    });
