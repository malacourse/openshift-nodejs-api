...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sApimachineryPkgVersionInfo();
  });
  ...
  describe('IoK8sApimachineryPkgVersionInfo', function() {
    it('should create an instance of IoK8sApimachineryPkgVersionInfo', function() {
      ...
      //var instane = new OpenShiftApiWithKubernetes.IoK8sApimachineryPkgVersionInfo();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sApimachineryPkgVersionInfo);
    });
