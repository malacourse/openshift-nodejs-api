...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAntiAffinity();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1PodAntiAffinity', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1PodAntiAffinity', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1PodAntiAffinity
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAntiAffinity();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAntiAffinity);
    });
