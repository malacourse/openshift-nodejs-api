...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus();
  });
  ...
  describe('IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus', function() {
    it('should create an instance of IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus);
    });
