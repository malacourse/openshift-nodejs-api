...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec);
    });
