...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec);
    });
