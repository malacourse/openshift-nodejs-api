...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1EnvFromSource();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1EnvFromSource', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1EnvFromSource', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1EnvFromSource
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1EnvFromSource();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1EnvFromSource);
    });
