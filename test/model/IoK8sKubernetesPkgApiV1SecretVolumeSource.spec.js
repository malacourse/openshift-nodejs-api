...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1SecretVolumeSource();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1SecretVolumeSource', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1SecretVolumeSource', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1SecretVolumeSource
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1SecretVolumeSource();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1SecretVolumeSource);
    });
