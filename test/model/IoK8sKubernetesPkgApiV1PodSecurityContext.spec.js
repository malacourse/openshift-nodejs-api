...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodSecurityContext();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1PodSecurityContext', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1PodSecurityContext', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1PodSecurityContext
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodSecurityContext();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodSecurityContext);
    });
