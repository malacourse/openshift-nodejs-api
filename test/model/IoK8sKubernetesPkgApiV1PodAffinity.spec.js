...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAffinity();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1PodAffinity', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1PodAffinity', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1PodAffinity
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAffinity();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1PodAffinity);
    });
