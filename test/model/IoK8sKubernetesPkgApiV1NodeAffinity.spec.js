...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1NodeAffinity();
  });
  ...
  describe('IoK8sKubernetesPkgApiV1NodeAffinity', function() {
    it('should create an instance of IoK8sKubernetesPkgApiV1NodeAffinity', function() {
      // uncomment below and update the code to test IoK8sKubernetesPkgApiV1NodeAffinity
      //var instane = new OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1NodeAffinity();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sKubernetesPkgApiV1NodeAffinity);
    });
