...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.IoK8sApimachineryPkgApisMetaV1DeleteOptions();
  });
  ...
  describe('IoK8sApimachineryPkgApisMetaV1DeleteOptions', function() {
    it('should create an instance of IoK8sApimachineryPkgApisMetaV1DeleteOptions', function() {
      ...
      //var instane = new OpenShiftApiWithKubernetes.IoK8sApimachineryPkgApisMetaV1DeleteOptions();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.IoK8sApimachineryPkgApisMetaV1DeleteOptions);
    });
