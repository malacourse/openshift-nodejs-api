...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource();
  });
  ...
  describe('ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource', function() {
    it('should create an instance of ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource', function() {
      // uncomment below and update the code to test ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource
      //var instane = new OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource();
      //expect(instance).to.be.a(OpenShiftApiWithKubernetes.ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource);
    });
