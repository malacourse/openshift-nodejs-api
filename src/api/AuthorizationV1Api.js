...
export default class AuthorizationV1Api {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createAuthorizationV1LocalSubjectAccessReviewForAllNamespaces operation.
     * @callback module:api/AuthorizationV1Api~createAuthorizationV1LocalSubjectAccessReviewForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1LocalSubjectAccessReview} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a LocalSubjectAccessReview
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1LocalSubjectAccessReview} body 
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:api/AuthorizationV1Api~createAuthorizationV1LocalSubjectAccessReviewForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1LocalSubjectAccessReview}
     */
    createAuthorizationV1LocalSubjectAccessReviewForAllNamespaces(body, opts, callback) {
      opts = opts || {};
      let postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createAuthorizationV1LocalSubjectAccessReviewForAllNamespaces");
      }
      ...
      let returnType = IoK8sKubernetesPkgApisAuthorizationV1LocalSubjectAccessReview;

      return this.apiClient.callApi(
        '/apis/authorization.k8s.io/v1/localsubjectaccessreviews', 'POST',
     ...
     * @param {String} error Error message, if any.
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SelfSubjectAccessReview} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a SelfSubjectAccessReview
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SelfSubjectAccessReview} body 
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     ...
     * data is of type: {@link module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SelfSubjectAccessReview}
     */
    createAuthorizationV1SelfSubjectAccessReview(body, opts, callback) {
      ...
      let contentTypes = ['*/*'];
      let accepts = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
      let returnType = IoK8sKubernetesPkgApisAuthorizationV1SelfSubjectAccessReview;
     ...
     * @param {String} error Error message, if any.
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SubjectAccessReview} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a SubjectAccessReview
     * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SubjectAccessReview} body 
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     ...
     * data is of type: {@link module:mikespgk/IoK8sKubernetesPkgApisAuthorizationV1SubjectAccessReview}
     */
    createAuthorizationV1SubjectAccessReview(body, opts, callback) {
      ...
      let contentTypes = ['*/*'];
      let accepts = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
      let returnType = IoK8sKubernetesPkgApisAuthorizationV1SubjectAccessReview;
