...
* @module mikespgk/IoK8sApimachineryPkgApisMetaV1OwnerReference
* @version v3.6.173.0.21
*/
export default class IoK8sApimachineryPkgApisMetaV1OwnerReference {
    /**
    * Constructs a new <code>IoK8sApimachineryPkgApisMetaV1OwnerReference</code>.
    * OwnerReference contains enough information to let you identify an owning object. Currently, an owning object must be in the same namespace, so there is no namespace field.
    * @alias module:mikespgk/IoK8sApimachineryPkgApisMetaV1OwnerReference
    * @class
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgApisMetaV1OwnerReference} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgApisMetaV1OwnerReference} The populated <code>IoK8sApimachineryPkgApisMetaV1OwnerReference</code> instance.
    */
