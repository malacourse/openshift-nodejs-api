...
* @module mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams
...
export default class ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams
    * @class
    */
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams} The populated <code>ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams</code> instance.
    */
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1LifecycleHook} post
    */
    post = undefined;
    /**
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1LifecycleHook} pre
    */
    pre = undefined;
    /**
