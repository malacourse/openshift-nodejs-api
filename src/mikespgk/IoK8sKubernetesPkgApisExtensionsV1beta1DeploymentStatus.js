...
* @module mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus
    * @class
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus</code> instance.
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentCondition>} conditions
    */
