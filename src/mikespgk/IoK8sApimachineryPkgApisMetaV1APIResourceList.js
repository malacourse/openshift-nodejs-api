...
* @module mikespgk/IoK8sApimachineryPkgApisMetaV1APIResourceList
* @version v3.6.173.0.21
*/
export default class IoK8sApimachineryPkgApisMetaV1APIResourceList {
    /**
    * Constructs a new <code>IoK8sApimachineryPkgApisMetaV1APIResourceList</code>.
    * APIResourceList is a list of APIResource, it is used to expose the name of the resources supported in a specific group and version, and if the resource is namespaced.
    * @alias module:mikespgk/IoK8sApimachineryPkgApisMetaV1APIResourceList
    * @class
    * @param groupVersion {String} groupVersion is the group and version this APIResourceList is for.
    * @param resources {Array.<module:mikespgk/IoK8sApimachineryPkgApisMetaV1APIResource>} resources contains the name of the resources and if they are namespaced.
    */
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgApisMetaV1APIResourceList} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgApisMetaV1APIResourceList} The populated <code>IoK8sApimachineryPkgApisMetaV1APIResourceList</code> instance.
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sApimachineryPkgApisMetaV1APIResource>} resources
    */
    resources = undefined;
