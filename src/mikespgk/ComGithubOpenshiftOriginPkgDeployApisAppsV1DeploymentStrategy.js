...
* @module mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy
...
export default class ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy
    * @class
    */
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy} The populated <code>ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy</code> instance.
    */
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1CustomDeploymentStrategyParams} customParams
    */
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RecreateDeploymentStrategyParams} recreateParams
    */
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1RollingDeploymentStrategyParams} rollingParams
    */
