...
* @module mikespgk/IoK8sApimachineryPkgApisMetaV1StatusDetails
* @version v3.6.173.0.21
*/
export default class IoK8sApimachineryPkgApisMetaV1StatusDetails {
    /**
    ...
    * @alias module:mikespgk/IoK8sApimachineryPkgApisMetaV1StatusDetails
    * @class
    */
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgApisMetaV1StatusDetails} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgApisMetaV1StatusDetails} The populated <code>IoK8sApimachineryPkgApisMetaV1StatusDetails</code> instance.
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sApimachineryPkgApisMetaV1StatusCause>} causes
    */
    causes = undefined;
    /**
