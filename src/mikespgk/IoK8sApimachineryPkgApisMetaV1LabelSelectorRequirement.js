...
* @module mikespgk/IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement
* @version v3.6.173.0.21
*/
export default class IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement {
    /**
    * Constructs a new <code>IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement</code>.
    * A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
    * @alias module:mikespgk/IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement
    * @class
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement} The populated <code>IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement</code> instance.
    */
