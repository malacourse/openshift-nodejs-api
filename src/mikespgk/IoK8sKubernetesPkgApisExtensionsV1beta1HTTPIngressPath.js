...
* @module mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath
    * @class
    * @param backend {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1IngressBackend} Backend defines the referenced service endpoint to which the traffic will be forwarded to.
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressPath</code> instance.
    */
