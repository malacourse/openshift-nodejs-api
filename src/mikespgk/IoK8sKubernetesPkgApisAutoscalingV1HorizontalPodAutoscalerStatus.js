...
/**
* The IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus model module.
* @module mikespgk/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus</code>.
    * current status of a horizontal pod autoscaler
    * @alias module:mikespgk/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus} The populated <code>IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus();
