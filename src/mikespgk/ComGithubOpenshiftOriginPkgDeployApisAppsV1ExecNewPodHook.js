...
* @module mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook
...
export default class ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook
    * @class
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook} The populated <code>ComGithubOpenshiftOriginPkgDeployApisAppsV1ExecNewPodHook</code> instance.
    */
