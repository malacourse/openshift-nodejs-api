...
* @module mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec
...
export default class ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec
    * @class
    * @param from {module:mikespgk/IoK8sKubernetesPkgApiV1ObjectReference} From points to a ReplicationController which is a deployment.
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec} The populated <code>ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigRollbackSpec</code> instance.
    */
