...
* @module mikespgk/IoK8sKubernetesPkgApiV1Container
...
export default class IoK8sKubernetesPkgApiV1Container {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1Container
    * @class
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1Container} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1Container} The populated <code>IoK8sKubernetesPkgApiV1Container</code> instance.
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1EnvFromSource>} envFrom
    */
    envFrom = undefined;
    /**
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1Lifecycle} lifecycle
    */
    lifecycle = undefined;
    /**
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1Probe} livenessProbe
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1ContainerPort>} ports
    */
    ports = undefined;
    /**
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1Probe} readinessProbe
    */
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1SecurityContext} securityContext
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1VolumeMount>} volumeMounts
    */
