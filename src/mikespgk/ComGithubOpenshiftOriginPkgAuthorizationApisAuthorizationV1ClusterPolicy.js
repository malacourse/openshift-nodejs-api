...
* @module mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy
...
export default class ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy
    * @class
    * @param lastModified {module:mikespgk/IoK8sApimachineryPkgApisMetaV1Time} LastModified is the last time that any part of the ClusterPolicy was created, updated, or deleted
    * @param roles {Array.<module:mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1NamedClusterRole>} Roles holds all the ClusterRoles held by this ClusterPolicy, mapped by ClusterRole.Name
    */
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy} The populated <code>ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1ClusterPolicy</code> instance.
    */
    ...
    * @member {Array.<module:mikespgk/ComGithubOpenshiftOriginPkgAuthorizationApisAuthorizationV1NamedClusterRole>} roles
    */
    roles = undefined;
