...
/**
* The IoK8sKubernetesPkgApisRbacV1beta1PolicyRule model module.
* @module mikespgk/IoK8sKubernetesPkgApisRbacV1beta1PolicyRule
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApisRbacV1beta1PolicyRule {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApisRbacV1beta1PolicyRule</code>.
    * PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.
    * @alias module:mikespgk/IoK8sKubernetesPkgApisRbacV1beta1PolicyRule
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApisRbacV1beta1PolicyRule</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApisRbacV1beta1PolicyRule} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisRbacV1beta1PolicyRule} The populated <code>IoK8sKubernetesPkgApisRbacV1beta1PolicyRule</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApisRbacV1beta1PolicyRule();
