...
import IoK8sKubernetesPkgApiV1ReplicationControllerCondition from './IoK8sKubernetesPkgApiV1ReplicationControllerCondition';
...
/**
* The IoK8sKubernetesPkgApiV1ReplicationControllerStatus model module.
* @module mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerStatus
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApiV1ReplicationControllerStatus {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApiV1ReplicationControllerStatus</code>.
    * ReplicationControllerStatus represents the current status of a replication controller.
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerStatus
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApiV1ReplicationControllerStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerStatus} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerStatus} The populated <code>IoK8sKubernetesPkgApiV1ReplicationControllerStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApiV1ReplicationControllerStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [IoK8sKubernetesPkgApiV1ReplicationControllerCondition]);
            }
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerCondition>} conditions
    */
