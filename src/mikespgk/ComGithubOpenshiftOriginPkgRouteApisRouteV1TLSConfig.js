...
* @module mikespgk/ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig
...
export default class ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig
    * @class
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig} The populated <code>ComGithubOpenshiftOriginPkgRouteApisRouteV1TLSConfig</code> instance.
    */
