...
* @module mikespgk/IoK8sKubernetesPkgApiV1ISCSIVolumeSource
...
export default class IoK8sKubernetesPkgApiV1ISCSIVolumeSource {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1ISCSIVolumeSource
    * @class
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1ISCSIVolumeSource} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1ISCSIVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1ISCSIVolumeSource</code> instance.
    */
