...
* @module mikespgk/IoK8sKubernetesPkgApiV1PodSecurityContext
...
export default class IoK8sKubernetesPkgApiV1PodSecurityContext {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1PodSecurityContext
    * @class
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1PodSecurityContext} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1PodSecurityContext} The populated <code>IoK8sKubernetesPkgApiV1PodSecurityContext</code> instance.
    */
