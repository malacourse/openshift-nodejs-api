...
* @module mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec
...
export default class ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec
    * @class
    * @param replicas {Number} Replicas is the number of desired replicas.
    * @param strategy {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy} Strategy describes how a deployment is executed.
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec} The populated <code>ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentConfigSpec</code> instance.
    */
    ...
    * @member {module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentStrategy} strategy
    */
    strategy = undefined;
    /**
    ...
    * @member {Array.<module:mikespgk/ComGithubOpenshiftOriginPkgDeployApisAppsV1DeploymentTriggerPolicy>} triggers
    */
    triggers = undefined;
