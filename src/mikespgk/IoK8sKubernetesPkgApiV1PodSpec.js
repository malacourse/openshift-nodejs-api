...
* @module mikespgk/IoK8sKubernetesPkgApiV1PodSpec
...
export default class IoK8sKubernetesPkgApiV1PodSpec {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1PodSpec
    * @class
    * @param containers {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1Container>} List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/containers
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1PodSpec} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1PodSpec} The populated <code>IoK8sKubernetesPkgApiV1PodSpec</code> instance.
    */
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1Affinity} affinity
    */
    affinity = undefined;
    /**
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1Container>} containers
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1Container>} initContainers
    */
    ...
    * @member {module:mikespgk/IoK8sKubernetesPkgApiV1PodSecurityContext} securityContext
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1Toleration>} tolerations
    */
    ...
    * @member {Array.<module:mikespgk/IoK8sKubernetesPkgApiV1Volume>} volumes
    */
    volumes = undefined;
