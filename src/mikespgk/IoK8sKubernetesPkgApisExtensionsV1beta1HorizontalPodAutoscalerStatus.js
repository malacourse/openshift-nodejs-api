...
/**
* The IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus model module.
* @module mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus</code>.
    * current status of a horizontal pod autoscaler
    * @alias module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus();
            ...
            if (data.hasOwnProperty('lastScaleTime')) {
                obj['lastScaleTime'] = IoK8sApimachineryPkgApisMetaV1Time.constructFromObject(data['lastScaleTime']);
            }
    ...
    * @member {module:mikespgk/IoK8sApimachineryPkgApisMetaV1Time} lastScaleTime
    */
