...
/**
* The IoK8sKubernetesPkgApiV1RBDVolumeSource model module.
* @module mikespgk/IoK8sKubernetesPkgApiV1RBDVolumeSource
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApiV1RBDVolumeSource {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApiV1RBDVolumeSource</code>.
    * Represents a Rados Block Device mount that lasts the lifetime of a pod. RBD volumes support ownership management and SELinux relabeling.
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1RBDVolumeSource
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApiV1RBDVolumeSource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1RBDVolumeSource} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1RBDVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1RBDVolumeSource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApiV1RBDVolumeSource();
