...
* @module mikespgk/IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR
* @version v3.6.173.0.21
*/
export default class IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR {
    /**
    * Constructs a new <code>IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR</code>.
    * ServerAddressByClientCIDR helps the client to determine the server address that they should use, depending on the clientCIDR that they match.
    * @alias module:mikespgk/IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR
    * @class
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR} The populated <code>IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR</code> instance.
    */
