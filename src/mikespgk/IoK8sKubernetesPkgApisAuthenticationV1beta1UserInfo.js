...
* @module mikespgk/IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo
...
export default class IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo
    * @class
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo} The populated <code>IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo</code> instance.
    */
