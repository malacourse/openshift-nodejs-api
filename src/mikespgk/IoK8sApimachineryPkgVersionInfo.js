...
* @module mikespgk/IoK8sApimachineryPkgVersionInfo
...
export default class IoK8sApimachineryPkgVersionInfo {
    ...
    * @alias module:mikespgk/IoK8sApimachineryPkgVersionInfo
    * @class
    ...
    * @param {module:mikespgk/IoK8sApimachineryPkgVersionInfo} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sApimachineryPkgVersionInfo} The populated <code>IoK8sApimachineryPkgVersionInfo</code> instance.
    */
