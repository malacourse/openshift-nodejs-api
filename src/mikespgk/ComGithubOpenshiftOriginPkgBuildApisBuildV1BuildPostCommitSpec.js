...
* @module mikespgk/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec
...
export default class ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec {
    ...
    * @alias module:mikespgk/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec
    * @class
    */
    ...
    * @param {module:mikespgk/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec} obj Optional instance to populate.
    * @return {module:mikespgk/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec} The populated <code>ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildPostCommitSpec</code> instance.
    */
