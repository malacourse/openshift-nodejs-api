...
* @module mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerSpec
...
export default class IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    ...
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerSpec
    * @class
    */
    ...
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerSpec} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1ReplicationControllerSpec} The populated <code>IoK8sKubernetesPkgApiV1ReplicationControllerSpec</code> instance.
    */
