...
/**
* The IoK8sKubernetesPkgApiV1CephFSVolumeSource model module.
* @module mikespgk/IoK8sKubernetesPkgApiV1CephFSVolumeSource
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApiV1CephFSVolumeSource {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApiV1CephFSVolumeSource</code>.
    * Represents a Ceph Filesystem mount that lasts the lifetime of a pod Cephfs volumes do not support ownership management or SELinux relabeling.
    * @alias module:mikespgk/IoK8sKubernetesPkgApiV1CephFSVolumeSource
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApiV1CephFSVolumeSource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:mikespgk/IoK8sKubernetesPkgApiV1CephFSVolumeSource} obj Optional instance to populate.
    * @return {module:mikespgk/IoK8sKubernetesPkgApiV1CephFSVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1CephFSVolumeSource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApiV1CephFSVolumeSource();
