...
* @module model/IoK8sKubernetesPkgApiV1SecurityContext
...
export default class IoK8sKubernetesPkgApiV1SecurityContext {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1SecurityContext
    * @class
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1SecurityContext} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1SecurityContext} The populated <code>IoK8sKubernetesPkgApiV1SecurityContext</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApiV1Capabilities} capabilities
    */
