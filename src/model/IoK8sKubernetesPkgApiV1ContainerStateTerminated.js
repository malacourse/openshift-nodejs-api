...
* @module model/IoK8sKubernetesPkgApiV1ContainerStateTerminated
...
export default class IoK8sKubernetesPkgApiV1ContainerStateTerminated {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1ContainerStateTerminated
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1ContainerStateTerminated} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ContainerStateTerminated} The populated <code>IoK8sKubernetesPkgApiV1ContainerStateTerminated</code> instance.
    */
