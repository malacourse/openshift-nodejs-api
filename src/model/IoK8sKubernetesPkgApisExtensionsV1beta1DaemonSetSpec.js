...
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec
    * @class
    * @param template {module:model/IoK8sKubernetesPkgApiV1PodTemplateSpec} An object that describes the pod that will be created. The DaemonSet will create exactly one copy of this pod on every node that matches the template's node selector (or on every node if no node selector is specified). More info: http://kubernetes.io/docs/user-guide/replication-controller#pod-template
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy} updateStrategy
    */
