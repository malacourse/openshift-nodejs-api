...
* @module model/IoK8sKubernetesPkgApiV1PersistentVolumeSpec
...
export default class IoK8sKubernetesPkgApiV1PersistentVolumeSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1PersistentVolumeSpec
    * @class
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1PersistentVolumeSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1PersistentVolumeSpec} The populated <code>IoK8sKubernetesPkgApiV1PersistentVolumeSpec</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApiV1ObjectReference} claimRef
    */
    claimRef = undefined;
    /**
