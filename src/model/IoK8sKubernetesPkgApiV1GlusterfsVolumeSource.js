...
* @module model/IoK8sKubernetesPkgApiV1GlusterfsVolumeSource
...
export default class IoK8sKubernetesPkgApiV1GlusterfsVolumeSource {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1GlusterfsVolumeSource
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1GlusterfsVolumeSource} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1GlusterfsVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1GlusterfsVolumeSource</code> instance.
    */
