...
* @module model/IoK8sKubernetesPkgApiV1ScaleIOVolumeSource
...
export default class IoK8sKubernetesPkgApiV1ScaleIOVolumeSource {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1ScaleIOVolumeSource
    * @class
    * @param gateway {String} The host address of the ScaleIO API Gateway.
    * @param secretRef {module:model/IoK8sKubernetesPkgApiV1LocalObjectReference} SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1ScaleIOVolumeSource} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ScaleIOVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1ScaleIOVolumeSource</code> instance.
    */
