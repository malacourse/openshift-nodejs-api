...
* @module model/IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec
...
export default class IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec
    * @class
    * @param jobTemplate {module:model/IoK8sKubernetesPkgApisBatchV2alpha1JobTemplateSpec} JobTemplate is the object that describes the job that will be created when executing a CronJob.
    ...
    * @param {module:model/IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec} The populated <code>IoK8sKubernetesPkgApisBatchV2alpha1CronJobSpec</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApisBatchV2alpha1JobTemplateSpec} jobTemplate
    */
