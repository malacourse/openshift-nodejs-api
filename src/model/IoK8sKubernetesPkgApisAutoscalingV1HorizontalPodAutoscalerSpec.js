...
* @module model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec
...
export default class IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec
    * @class
    ...
    * @param scaleTargetRef {module:model/IoK8sKubernetesPkgApisAutoscalingV1CrossVersionObjectReference} reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec} The populated <code>IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerSpec</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApisAutoscalingV1CrossVersionObjectReference} scaleTargetRef
    */
