...
* @module model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus
...
export default class IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus} The populated <code>IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus</code> instance.
    */
