...
* @module model/IoK8sKubernetesPkgApiV1ServicePort
...
export default class IoK8sKubernetesPkgApiV1ServicePort {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1ServicePort
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1ServicePort} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ServicePort} The populated <code>IoK8sKubernetesPkgApiV1ServicePort</code> instance.
    */
