...
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec
    * @class
    * @param fsGroup {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1FSGroupStrategyOptions} FSGroup is the strategy that will dictate what fs group is used by the SecurityContext.
    * @param runAsUser {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1RunAsUserStrategyOptions} runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
    * @param seLinux {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1SELinuxStrategyOptions} seLinux is the strategy that will dictate the allowable labels that may be set.
    * @param supplementalGroups {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1SupplementalGroupsStrategyOptions} SupplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec</code> instance.
    */
    ...
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1FSGroupStrategyOptions} fsGroup
    */
    fsGroup = undefined;
    /**
    ...
    * @member {Array.<module:model/IoK8sKubernetesPkgApisExtensionsV1beta1HostPortRange>} hostPorts
    */
    hostPorts = undefined;
    /**
    ...
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1RunAsUserStrategyOptions} runAsUser
    */
    runAsUser = undefined;
    /**
    * seLinux is the strategy that will dictate the allowable labels that may be set.
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1SELinuxStrategyOptions} seLinux
    */
    seLinux = undefined;
    /**
    * SupplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1SupplementalGroupsStrategyOptions} supplementalGroups
    */
