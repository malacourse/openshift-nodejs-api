...
* @module model/IoK8sKubernetesPkgApisBatchV1JobSpec
...
export default class IoK8sKubernetesPkgApisBatchV1JobSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisBatchV1JobSpec
    * @class
    * @param template {module:model/IoK8sKubernetesPkgApiV1PodTemplateSpec} Template is the object that describes the pod that will be created when executing a job. More info: http://kubernetes.io/docs/user-guide/jobs
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApisBatchV1JobSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisBatchV1JobSpec} The populated <code>IoK8sKubernetesPkgApisBatchV1JobSpec</code> instance.
    */
