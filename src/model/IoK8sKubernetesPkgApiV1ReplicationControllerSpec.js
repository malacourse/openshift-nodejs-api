...
/**
* The IoK8sKubernetesPkgApiV1ReplicationControllerSpec model module.
* @module model/IoK8sKubernetesPkgApiV1ReplicationControllerSpec
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApiV1ReplicationControllerSpec</code>.
    * ReplicationControllerSpec is the specification of a replication controller.
    * @alias module:model/IoK8sKubernetesPkgApiV1ReplicationControllerSpec
    * @class
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApiV1ReplicationControllerSpec</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/IoK8sKubernetesPkgApiV1ReplicationControllerSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ReplicationControllerSpec} The populated <code>IoK8sKubernetesPkgApiV1ReplicationControllerSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApiV1ReplicationControllerSpec();
