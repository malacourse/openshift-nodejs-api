...
* @module model/IoK8sKubernetesPkgApiV1ServiceAccount
...
export default class IoK8sKubernetesPkgApiV1ServiceAccount {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1ServiceAccount
    * @class
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1ServiceAccount} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ServiceAccount} The populated <code>IoK8sKubernetesPkgApiV1ServiceAccount</code> instance.
    */
    ...
    * @member {Array.<module:model/IoK8sKubernetesPkgApiV1ObjectReference>} secrets
    */
    secrets = undefined;
