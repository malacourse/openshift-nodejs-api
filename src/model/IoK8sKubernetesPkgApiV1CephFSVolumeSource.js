...
* @module model/IoK8sKubernetesPkgApiV1CephFSVolumeSource
...
export default class IoK8sKubernetesPkgApiV1CephFSVolumeSource {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1CephFSVolumeSource
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1CephFSVolumeSource} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1CephFSVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1CephFSVolumeSource</code> instance.
    */
