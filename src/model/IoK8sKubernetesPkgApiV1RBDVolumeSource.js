...
* @module model/IoK8sKubernetesPkgApiV1RBDVolumeSource
...
export default class IoK8sKubernetesPkgApiV1RBDVolumeSource {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1RBDVolumeSource
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1RBDVolumeSource} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1RBDVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1RBDVolumeSource</code> instance.
    */
