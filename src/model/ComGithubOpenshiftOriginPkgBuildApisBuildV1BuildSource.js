...
* @module model/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource
...
export default class ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource {
    ...
    * @alias module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource
    * @class
    ...
    * @param {module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource} obj Optional instance to populate.
    * @return {module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource} The populated <code>ComGithubOpenshiftOriginPkgBuildApisBuildV1BuildSource</code> instance.
    */
    ...
    * @member {module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1GitBuildSource} git
    */
    git = undefined;
    /**
    * images describes a set of images to be used to provide source for the build
    * @member {Array.<module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1ImageSource>} images
    */
    images = undefined;
    /**
    * secrets represents a list of secrets and their destinations that will be used only for the build.
    * @member {Array.<module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1SecretBuildSource>} secrets
    */
    secrets = undefined;
    /**
    ...
    * @member {module:model/IoK8sKubernetesPkgApiV1LocalObjectReference} sourceSecret
    */
