...
* @module model/ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy
...
export default class ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy {
    ...
    * @alias module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy
    * @class
    */
    ...
    * @param {module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy} obj Optional instance to populate.
    * @return {module:model/ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy} The populated <code>ComGithubOpenshiftOriginPkgBuildApisBuildV1DockerBuildStrategy</code> instance.
    */
    ...
    * @member {Array.<module:model/IoK8sKubernetesPkgApiV1EnvVar>} buildArgs
    */
    buildArgs = undefined;
    /**
