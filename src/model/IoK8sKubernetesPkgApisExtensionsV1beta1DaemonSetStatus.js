...
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus</code> instance.
    */
