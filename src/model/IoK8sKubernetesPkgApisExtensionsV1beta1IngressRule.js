...
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule
    * @class
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1IngressRule</code> instance.
    */
    ...
    */
    host = undefined;
    /**
    * @member {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1HTTPIngressRuleValue} http
    */
    http = undefined;
