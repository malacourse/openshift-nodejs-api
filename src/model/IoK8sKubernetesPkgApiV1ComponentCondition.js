...
* @module model/IoK8sKubernetesPkgApiV1ComponentCondition
...
export default class IoK8sKubernetesPkgApiV1ComponentCondition {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1ComponentCondition
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1ComponentCondition} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1ComponentCondition} The populated <code>IoK8sKubernetesPkgApiV1ComponentCondition</code> instance.
    */
