...
* @module model/IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec
...
export default class IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec
    * @class
    */
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec} The populated <code>IoK8sKubernetesPkgApiV1PersistentVolumeClaimSpec</code> instance.
    */
