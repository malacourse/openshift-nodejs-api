...
/**
* The IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec model module.
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec
* @version v3.6.173.0.21
*/
export default class IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
    /**
    * Constructs a new <code>IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec</code>.
    * ReplicaSetSpec is the specification of a ReplicaSet.
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec
    * @class
    */
    ...
    /**
    * Constructs a <code>IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec();
