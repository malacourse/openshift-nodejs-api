...
* @module model/IoK8sKubernetesPkgApiV1GitRepoVolumeSource
...
export default class IoK8sKubernetesPkgApiV1GitRepoVolumeSource {
    ...
    * @alias module:model/IoK8sKubernetesPkgApiV1GitRepoVolumeSource
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApiV1GitRepoVolumeSource} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApiV1GitRepoVolumeSource} The populated <code>IoK8sKubernetesPkgApiV1GitRepoVolumeSource</code> instance.
    */
