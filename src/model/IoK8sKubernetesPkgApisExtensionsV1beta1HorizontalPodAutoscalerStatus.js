...
* @module model/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus
...
export default class IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus {
    ...
    * @alias module:model/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus
    * @class
    ...
    * @param {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus} obj Optional instance to populate.
    * @return {module:model/IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus} The populated <code>IoK8sKubernetesPkgApisExtensionsV1beta1HorizontalPodAutoscalerStatus</code> instance.
    */
    ...
    * @member {module:model/IoK8sApimachineryPkgApisMetaV1Time} lastScaleTime
    */
